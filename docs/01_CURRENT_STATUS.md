...
- Preview `dpl_7e8Pt1Sf4xvJiitjduJaW5ENe6y2` and production `dpl_3Zt6ncqJDo1u8NsTiddduEofZ7Bq` are Ready on exact commit `34b4131821145363e6245ea5fff64aa70625d77f`; live bytes match local.
...
- Local PDF is one page with 9 annotations, one `ACHIEVEMENT` heading, two Mahoraga mentions, and SHA-256 `EEA2CE0CCC22E6B3E7F6235810D24C12DA7BBCD56EEE2EE30F96C467D78D160`.
- Preview `dpl_14fHMsqnKagU4kYtVgLChaKJhpwg` and production `dpl_G44WUuLiAoGFKogGTHxA4S1YY1jY` are Ready on exact commit `dea4998e4f90cebc3c2905e01f948226b008fd50`; live PDF matches the local hash.
...
- Preview `dpl_7EG9L5xLuTvowLBAapUNpL2gigSY` and production `dpl_7JR9sona2AdhR27Jai1hAjdr9fhB` are Ready and tied to the exact release commit above.
- Live PDF verification returned HTTP 200 with `application/pdf`, one page, matching bytes/hash, 2 Mahoraga mentions, 1 `ACHIEVEMENT` heading, zero certificate-number text occurrences, and 9 annotations. Browser smoke passed at desktop and 390x844 with 3 resume CTAs, no horizontal overflow, and no console/page errors.

2026-08-09 certificate-link and certification-layout revision:
- The resume keeps the wrapped `fundamentals.` certification line fully visible, removes the separate certificate-number text, and attaches the certificate URL to the Def-Space internship heading.
- Local PDF validation passed for one-page A4 layout, clean extraction, 8 annotations, and visual review. Local public asset SHA-256 is `E6D16BFB1D76E055EFD9F941A5AF52E903C59B6E4C61BAFFFFBB7F584915F03C`.
- Production deployment `dpl_G6U5mEEMPssxTHmfNqHd1mU1ugUR` is Ready and tied to the exact release commit `ad1fcb0ed566cf2c37f4ccd3f02b627beca37463`.
- Live verification returned HTTP 200 with `application/pdf`, one page, zero certificate-number text occurrences, and the certificate link attached to the Def-Space internship heading. SHA-256: `E6D16BFB1D76E055EFD9F941A5AF52E903C59B6E4C61BAFFFFBB7F584915F03C`.
