...
- Local PDF structure and link checks are complete. The release passed 50/50 tests, lint, and static build; production deployment `dpl_9CXgmTR5h3eFbN54c1ZFo7JULjQR` is Ready, with both asset paths returning `200 application/pdf` and matching local SHA-256 values.
...
- Local and live asset SHA-256: `EEA2CE0CCC22E6B3E7F6235810D24C12DA7BBCD56EEE2EE30F96C467D78D160`; production deployment `dpl_G44WUuLiAoGFKogGTHxA4S1YY1jY` is Ready on commit `dea4998e4f90cebc3c2905e01f948226b008fd50`.
...
- Local and live asset SHA-256: `9C4D23555B299186AEEFD74468386794E348B3BCA6DE86ADE2A9C7056EFEC71B`; production deployment `dpl_7JR9sona2AdhR27Jai1hAjdr9fhB` is Ready on commit `41084e6801c63d9487ab5f55f9f317076b7accbc`.
...
- Final-polish screenshot recapture completed on 2026-07-08 with Edge headless: homepage desktop/mobile plus Mahoraga, Hybrid, and The Loop desktop captures. A mobile hero clipping issue was found and fixed before the final mobile screenshot was accepted.
