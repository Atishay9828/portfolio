...
export const featuredProjects: Project[] = [
  ...
  },
  {
    ...
    visual: {
      ...
      detail: "Prediction-flow and merchant-memory screenshots were replaced with captures from the running Hybrid frontend using synthetic demo transactions. Category/history screenshots remain sample-labeled case-study candidates; benchmark/routing proof remains pending.",
      assets: [
        {
    ...
    caseStudy: {
      ...
      routingProof: {
        ...
        note: "Sample routing proof exists from documented project examples, but no measured latency is published yet. ONNX model/runtime asset missing in local verification: `models/distilbert.onnx` was not present, so this is architecture proof rather than measured performance proof.",
        columns: [
          "Input text",
        ...
        rows: [
          [
            ...
            "Merchant override",
            "sample/unmeasured",
            "Merchant extraction and route are supported by repo docs/code; no measured runtime output captured.",
          ],
          [
            ...
            "Unknown",
            "sample/unmeasured",
            "Merchant extraction is documented; category and route were not confirmed by a runtime/model result.",
          ],
          [
          ...
          [
            ...
            "Merchant override",
            "sample/unmeasured",
            "Merchant extraction is documented; merchant-map/code evidence supports Travel via `volvo`; no measured runtime output captured.",
          ],
        ],
      },
      limitations: [
      ...
      nextEvidenceNeeded: [
        "Measured routing run using the sample table and additional safe cases.",
        "Measured latency/cost only if captured with a repeatable method and documented calculation.",
        "Restore or generate `models/distilbert.onnx` before local backend/model verification.",
