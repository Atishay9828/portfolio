      ...
      assets: [
        {
          ...
          status: "Known",
          note: "Imported from the verified Mahoraga repo; needs final visual review before use as polished evidence.",
        ...
        },
        {
          ...
          status: "Known",
          note: "Imported as a real repo artifact, but metric claims remain blocked until the chart is reviewed and interpreted.",
      ...
      assets: [
        {
          ...
          label: "Prediction flow screenshot candidate",
          status: "Known",
          note: "Imported from the verified Hybrid Categorizer repo; needs final visual review before polished use.",
        ...
        },
        {
          ...
          label: "Categories dashboard screenshot candidate",
          status: "Known",
          note: "Imported from the verified Hybrid Categorizer repo; contains sample spending values and needs review before metric-like presentation.",
        ...
        },
        {
          ...
          status: "Known",
          note: "Imported from the verified Hybrid Categorizer repo; needs transaction privacy review before polished use.",
        ...
        },
        {
          ...
          label: "Merchant memory screenshot candidate",
          status: "Known",
          note: "Imported from the verified Hybrid Categorizer repo; needs review before using as memory proof.",
      ...
      assets: [
        {
          ...
          status: "Known",
          note: "Imported from the verified The Loop repo, but it is low resolution and should be replaced before production polish.",
        ...
        },
        {
          ...
          status: "Known",
          note: "Imported from the verified The Loop repo; needs final visual review and workflow context before polished use.",
